...
async function main() {
    ...
    // === 6. CREATE PRODUCTS ===
    const productsData = [
        { name: "LED Panel Light 60W", description: "Ultra-slim LED panel light, 60W, warm white", sku: "LED-PNL-60W", purchasePrice: 25.00, sellingPrice: 45.99, stock: 50, minStock: 10, images: ["/images/products/led-panel.png"], categoryId: categories[0].id },
        { name: "Smart Switch 3-Gang", description: "Touch-sensitive smart wall switch, 3-gang, WiFi", sku: "SW-SMART-3G", purchasePrice: 18.00, sellingPrice: 34.99, stock: 75, minStock: 10, images: ["/images/products/smart-switch.png"], categoryId: categories[2].id },
        { name: "Industrial Cable 100m", description: "Heavy-duty industrial cable, 100m roll, 2.5mm²", sku: "CBL-IND-100M", purchasePrice: 55.00, sellingPrice: 89.99, stock: 30, minStock: 5, images: ["/images/home/hero-cables.png"], categoryId: categories[1].id },
        { name: "Smart LED Bulb RGB", description: "WiFi-enabled smart LED bulb with RGB color control", sku: "LED-SMART-RGB", purchasePrice: 8.00, sellingPrice: 18.99, stock: 200, minStock: 20, images: ["/images/products/smartbulb.jpg"], categoryId: categories[0].id },
        { name: "Ethernet Cable Cat6 50m", description: "High-speed Cat6 ethernet cable, 50m, shielded", sku: "CBL-ETH-CAT6", purchasePrice: 12.00, sellingPrice: 24.99, stock: 100, minStock: 15, images: ["/images/products/ethernet.jpg"], categoryId: categories[1].id },
        { name: "Circuit Breaker 32A", description: "Miniature circuit breaker, 32A, single pole", sku: "CB-MCB-32A", purchasePrice: 12.00, sellingPrice: 24.99, stock: 120, minStock: 20, images: ["/images/products/circuit.jpg"], categoryId: categories[5].id },
        ...
        { name: "Voltage Tester Pro", description: "Non-contact voltage tester with LED indicator", sku: "TL-VTESTER", purchasePrice: 15.00, sellingPrice: 29.99, stock: 90, minStock: 10, images: ["/images/categories/safety.jpg"], categoryId: categories[5].id },
    ];
    const products = [];
