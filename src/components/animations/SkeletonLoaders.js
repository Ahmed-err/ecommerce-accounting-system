...
export function SkeletonHero() {
  return (
    <section className="relative overflow-hidden bg-muted/30 pt-16 pb-24">
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-4xl mx-auto space-y-6">
          <div className="h-8 bg-muted rounded-full animate-pulse w-48 mx-auto" />
          <div className="h-16 bg-muted rounded animate-pulse" />
          <div className="h-16 bg-muted rounded animate-pulse w-2/3 mx-auto" />
          <div className="h-6 bg-muted rounded animate-pulse max-w-2xl mx-auto" />
          <div className="flex justify-center gap-4 pt-4">
            <div className="h-14 bg-muted rounded-xl animate-pulse w-40" />
            <div className="h-14 bg-muted rounded-xl animate-pulse w-40" />
          </div>
        </div>
      </div>
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="space-y-6">
          ...
          <div className="h-14 bg-muted rounded-xl animate-pulse w-48" />
        </div>
      </div>
    </div>
  );
...
export function SkeletonCart() {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
      ...
      <div className="h-64 bg-card border border-border rounded-xl p-6 animate-pulse" />
    </div>
  );
}
